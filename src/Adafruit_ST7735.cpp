...
# define RS_CLR digitalWrite(_rs, LOW);
# define RS_SET digitalWrite(_rs, HIGH);
# define CS_CLR digitalWrite(_cs, LOW);
# define CS_SET digitalWrite(_cs, HIGH);
# define RES_CLR digitalWrite(_rst, LOW);
# define RES_SET digitalWrite(_rst, HIGH);

Adafruit_ST7735::Adafruit_ST7735(SPIClass *_pSPI, int8_t cs, int8_t rs, int8_t rst)
